      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-gray-600 mb-6 leading-relaxed">
            We are here to help with orders, returns, or anything about Onclick Shop. Use the quick form or open the full contact page.
          </p>
          <button
            type="button"
        ...
        <form onSubmit={handleQuickSend} className="bg-white rounded-2xl shadow-md p-6 border border-gray-100 space-y-4">
          {ok && <p className="text-sm text-green-600">Thanks — we will get back to you.</p>}
          <div>
          ...
          <button type="submit" className="btn w-full bg-orange-500 hover:bg-orange-600 text-white border-0">
            Send
          </button>
        </form>
      </div>
