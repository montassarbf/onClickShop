        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 mb-8">
          ...
          <nav className="flex flex-wrap justify-center gap-x-6 gap-y-2">
            {[
              ...
              { label: "New Arrivals", action: () => scrollTo("new") },
          ...
          <div className="flex items-center gap-3">
            {/* Instagram */}
            <a href="#" className="w-8 h-8 rounded-full bg-gray-100 hover:bg-orange-50 hover:text-orange-400 text-gray-400 flex items-center justify-center transition duration-200">
