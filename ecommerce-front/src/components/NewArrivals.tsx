...
/** "New Arrivals" section displayed on the Landing page. */
  ...
  <section id="new" className="min-h-[40vh] bg-white px-6 py-20 border-t border-gray-100">
    <div className="max-w-7xl mx-auto text-center">
      ...
      <p className="text-gray-600 max-w-2xl mx-auto mb-10">
        Fresh styles and limited drops are added to the shop regularly.
        Scroll up to browse the full catalog or jump straight to the shop.
      </p>
      <button
        type="button"
